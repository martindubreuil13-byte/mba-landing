...
const title = "What Does a Business Architect Do? | Martin Dubreuil";
const description = "A Business Architect connects the entrepreneur, idea, customer, offer, economics and execution to work out what business should exist and how to make it real.";
const path = "/answers/what-does-a-business-architect-do";
const canonicalUrl = `${SITE_URL}${path}`;
const ogImageUrl = "https://modernbusinessarchitect.com/og/what-does-a-business-architect-do.png";
