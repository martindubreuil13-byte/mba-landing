...
const title = "How Do I Find a Business Idea? | Martin Dubreuil";
const description = "Want to start a business but don't know what to start? A practical way to find business ideas by observing real problems, desires, changes and opportunities.";
const path = "/answers/how-do-i-find-a-business-idea";
const canonicalUrl = `${SITE_URL}${path}`;
const ogImageUrl = "https://modernbusinessarchitect.com/og/how-do-i-find-a-business-idea.png";
